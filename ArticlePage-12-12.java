...
public class ArticlePage extends TribunePage {
    ...
    public void verifyCommentsAdLeaderboard(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        goToUrl(url);
        Utils.writeToLog("ENTERING verifyCommentsAdLeaderboard METHOD");
        try {						
            ...
            Utils.logWrongCheck("commentsLeaderboard problem");
        }
    ...
    public void signIntoCommentsAccount(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        ...
        try {
            ...
            Assert.assertTrue(isSignInLinkVisible(), "comments submit button is not visible");
            Utils.logCorrectCheck("CORRECT: Log In link on Comment Page link is present.");
        } catch (NoSuchElementException e2) {
            Utils.logWrongCheck("signInLink problem");
        }
        boolean visible = signInLink.isDisplayed();
        Utils.writeToLog("signInLink is: " + visible);
        signInLink.click();
        WebDriver newwindow = switchHandleToPopup();  //PANEL WITH EMAIL & PASSWD
        ...
        submitLogInButton.click();  //SIGN IN ACCT PANEL
        Utils.logCorrectCheck("CORRECT: Log on to Comment Page successfully.");
        Utils.writeToLog("ENTERING VERIFYCOMMENTSPANEL METHOD->WRITE COMMENT");
        Date date = new Date();
        Thread.sleep(30000);			
        TribuneDriver.getInstance().getDriver().findElement(By.name("vf_content")).sendKeys("this is a TEST COMMENT on " + date);
        TribuneDriver.getInstance().getDriver().findElement(By.xpath("//button[@type='submit']")).click();
    ...
    public void verifyCommentsTextArea(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        ...
        goToUrl(url);
        try {
            Assert.assertNotNull(commentsTextArea);	
        } catch (NoSuchElementException e) {
    ...
    public void verifyCommentsPanelModBody(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        Utils.writeToLog("ENTERING VERIFYCOMMENTSPANELMODBODY METHOD->VERIFYING COMMENTS PANELMOD IS PRESENT");
        Utils.writeToLog("ENTERING VERIFYCOMMENTSPANELMODBODY METHOD->VERIFYING COMMENTS NUMBERS MATCH");
        refresh();
        Utils.writeToLog("REFRESHING PAGE:" + url);
        String commentsNumbFromPage = getCommentsNumber();
        Utils.logCorrectCheck("commentsNumbFromPage is:" + commentsNumbFromPage);  //correct
        ...
        Utils.logCorrectCheck("getCommentsOpenerNumber is:" + commentsNumbFromOpener);
        //commentsNumbFromOpener is the number of comments on the article page comments opener
        
        try {
            Assert.assertNotNull(commentsPanelModBody);	
        } catch (NoSuchElementException e) {
            Assert.fail("commentsPanelModBody problem");	
            Utils.logWrongCheck("commentsPanelModBody problem");
    ...
    public void verifyCommentsPanelOpener(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        ...
        try {
            Assert.assertNotNull(commentsPanelOpener);	
        } catch (NoSuchElementException e) {
            Utils.logWrongCheck("commentsPanelOpener problem");
        }
    }
    ...
    public void verifyCommentsPanelCloser(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        ...
        //        refresh();
        try {
            Assert.assertNotNull(commentsPanelCloser);	
        } catch (NoSuchElementException e) {
            Utils.logWrongCheck("commentsPanelCloser problem");
        }
    ...
    public void verifyChildComments(String url) throws InterruptedException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException, ParseException {
        ...
        //        refresh();
        try {
            Assert.assertNotNull(childComments);		
        } catch (NoSuchElementException e) {
            Utils.logWrongCheck("commentsPanelCloser problem");
        }
